            ...
            <{foreach $rows as $row}>
                <tr>
                    ...
                    <td class="text-center ">
                        <a href="?op=op_form&kind=<{$row.kind}>&sn=<{$row.sn}>&ofsn=<{$row.ofsn}>"><i class="far fa-edit"></i></a>
                ...
                <div class="col-sm-4">
									<div class="form-group">
										...
										<select name="ofsn" id="ofsn" class="form-control">
											...
											<{foreach $row.ofsn_option as $ofsn_option}>
												<option value="<{$ofsn_option.sn}>"  <{if $row.ofsn == $ofsn_option.sn}>selected<{/if}>>&nbsp;&nbsp;&nbsp;&nbsp;<{$ofsn_option.title}></option>
												<{foreach  $ofsn_option.sub as $sub}>	
													<option value="<{$sub.sn}>"   <{if $row.ofsn == $sub.sn}>selected<{/if}>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<{$sub.title}></option>
												<{/foreach}>												
											<{/foreach}>
										</select>
									</div>
